...
export default {
  ...
  data() {
    return {
      ...
      tablelistPenugasanSemuaDosen: null,
      total: 0,
      listLoading: true,
      listQuery: {
        page: 1,
  ...
  methods: {
    ...
    getTotal() {
      this.$store.dispatch('GetListPenugasanSemuaDosen', '').then(() => {
        this.listLoading = false
        this.total = this.$store.getters.listPenugasanSemuaDosen.length
    ...
    fetchData() {
      ...
      this.$store.dispatch('GetListPenugasanSemuaDosen', this.listQuery).then(() => {
        this.listLoading = true
        this.listPenugasanSemuaDosen = this.$store.getters.listPenugasanSemuaDosen
        console.log(this.listPenugasanSemuaDosen)
        this.tablelistPenugasanSemuaDosen = this.listPenugasanSemuaDosen
        console.log(this.tablelistPenugasanSemuaDosen)
        this.listLoading = false
      }).catch(() => {
        this.listLoading = false
      })

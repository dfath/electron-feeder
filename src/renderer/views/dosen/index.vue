  ...
  methods: {
    ...
    getTotal() {
      this.$store.dispatch('GetListDosen', '').then(() => {
        ...
        this.total = this.$store.getters.listDosen.length
    ...
    fetchData() {
      ...
      this.$store.dispatch('GetListDosen', this.listQuery).then(() => {
        this.listLoading = true
        this.listDosen = this.$store.getters.listDosen
        console.log(this.listDosen)
        this.tablelistDosen = this.listDosen
        console.log(this.tablelistDosen)
        this.listLoading = false
      }).catch(() => {
        this.listLoading = false
      })

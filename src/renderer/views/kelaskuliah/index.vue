...
export default {
  ...
  methods: {
    ...
    getTotal() {
      this.$store.dispatch('GetListKelasKuliah', '').then(() => {
        this.listLoading = false
        this.total = this.$store.getters.listKelasKuliah.length
    ...
    fetchData() {
      ...
      this.$store.dispatch('GetListKelasKuliah', this.listQuery).then(() => {
        this.listLoading = true
        this.listKelasKuliah = this.$store.getters.listKelasKuliah
        console.log(this.listKelasKuliah)
        this.tablelistKelasKuliah = this.listKelasKuliah
        console.log(this.tablelistKelasKuliah)
        this.listLoading = false
      }).catch(() => {
        this.listLoading = false
      })

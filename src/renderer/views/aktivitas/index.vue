...
export default {
  ...
  data() {
    return {
      ...
      tablelistAktivitasMahasiswa: null,
      total: 0,
      listLoading: true,
      listQuery: {
        page: 1,
  ...
  methods: {
    ...
    getTotal() {
      this.$store.dispatch('GetListAktivitasMahasiswa', '').then(() => {
        this.listLoading = false
        this.total = this.$store.getters.listAktivitasMahasiswa.length
    ...
    fetchData() {
      ...
      this.$store.dispatch('GetListAktivitasMahasiswa', this.listQuery).then(() => {
        this.listLoading = true
        this.listAktivitasMahasiswa = this.$store.getters.listAktivitasMahasiswa
        console.log(this.listAktivitasMahasiswa)
        this.tablelistAktivitasMahasiswa = this.listAktivitasMahasiswa
        console.log(this.tablelistAktivitasMahasiswa)
        this.listLoading = false
      }).catch(() => {
        this.listLoading = false
      })
